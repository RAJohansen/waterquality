...
raster_B5 = raster(all_rasters_names[[5]])
raster_template = raster(raster_B5)

### Resample and Stack All Rasters ---------------------------------------------
resampled_stack = all_rasters_names %>% 
  lapply(raster) %>% 

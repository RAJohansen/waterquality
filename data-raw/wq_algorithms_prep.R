...
wq_algorithms = tribble(
  ...
  "Be16FLHblue", Be16FLHblue, c(3, 5, 2), NA, c(3, 4, 2), NA, c(4, 7, 2),"chlorophyll",  
  ...
  "Ku15PhyCI", Ku15PhyCI, c(5, 5, 6), NA, NA, NA, c(8, 7, 9),  "phycocyanin", 
  ...
  "Zh10FLH", Zh10FLH, c(5, 6, 5), NA, NA, NA, c(8, 9, 7), "chlorophyll",
  ...
  "MM12NDCIalt", MM12NDCIalt, c(6, 5), NA, NA, NA, c(9, 7), "phycocyanin",

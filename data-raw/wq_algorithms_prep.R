...
wq_algorithms = tribble(
  ...
  "Be16FLHblue", Be16FLHblue, c(3, 5, 2), NA, c(3, 4, 2), NA, c(4, 7, 2), c(5, 8, 3),"chlorophyll",  
  "Be16FLHviolet", Be16FLHviolet, c(3, 5, 1), c(2, 4, 1), c(3, 4, 1), NA, c(4, 7, 1), c(5, 8, 2),"chlorophyll",
  ...
  "Go04MCI", Go04MCI, c(6, 5, 6), c(5, 4, 6), NA, NA, c(9, 8, 10), c(11, 10, 12), "phycocyanin",
  ...
  "Ku15PhyCI", Ku15PhyCI, c(5, 5, 6), NA, NA, NA, c(8, 7, 9), c(10, 8, 11), "phycocyanin", 
  ...
  "Be16NDTIblue", Be16NDTIblue, c(5, 2), c(4, 2), c(4, 2), NA, c(7, 2), c(8, 3), "chlorophyll",
  "Be16NDTIviolet", Be16NDTIviolet, c(5, 1), c(4, 1), c(4, 1), NA, c(7, 2),"chlorophyll",  
  "Be16FLHBlueRedNIR", Be16FLHBlueRedNIR, c(5, 7, 2), c(4, 9, 2), c(4, 5, 2), NA, c(7, 13, 2), c(8, 17, 3),"phycocyanin",
  "Be16FLHGreenRedNIR", Be16FLHGreenRedNIR, c(5, 7, 4), c(4, 9, 3), c(4, 5, 3), NA, c(7, 13, 5), c(8, 17, 6),"phycocyanin",
  "Be16FLHVioletRedNIR", Be16FLHVioletRedNIR, c(5, 7, 1), c(4, 9, 1), c(4, 5, 1), NA, c(7, 13, 2), c(8, 17, 3),"phycocyanin",
  "Wy08CI", Wy08CI, c(5, 5, 6), c(4, 4, 5), NA, NA, c(8, 7, 9), c(10, 8, 11), "phycocyanin",
  "Da052BDA", Da052BDA, c(6, 5), c(5, 4), NA, NA, c(9, 7), c(11, 8), "phycocyanin",
  "Zh10FLH", Zh10FLH, c(5, 6, 5), NA, NA, NA, c(8, 9, 7), c(10, 11, 8), "chlorophyll",
  ...
  "Be16MPI", Be16MPI, c(4, 4, 5), NA, NA, NA, c(6, 6, 7), c(7, 7, 8), "phycocyanin",
  ...
  "Ku15SLH", Ku15SLH, c(6, 5), c(5, 4), NA, NA, c(9, 7), c(11, 8), "phycocyanin",

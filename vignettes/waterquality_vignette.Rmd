...
worldview_2 = tibble::tribble(
  ~`Band Number`, ~band_name,                 ~band_center,                                  
  1,            "Coastal",                  0.425,                                                 
  2,            "Blue",                     0.480,
  3,            "Green",                    0.545,
  4,            "Yellow",                   0.605,
...
knitr::kable(worldview_2, align = c("l", "r", "r"), caption = "My caption")
```
...
knitr::kable(sentinel_2, align = c("l", "r", "r"), caption = "My caption")
```
...
knitr::kable(landsat_8, align = c("l", "r", "r"), caption = "My caption")
```
...
knitr::kable(meris, align = c("l", "r", "r"), caption = "My caption")
...
knitr::kable(modis, align = c("l", "r", "r"), caption = "My caption")
```
